...
set STAMP=%STAMP: =0%
set OUTLOG=%PROJECT%\outputs\logs\train_sanpo_newsplit_%STAMP%.out.log
set ERRLOG=%PROJECT%\outputs\logs\train_sanpo_newsplit_%STAMP%.err.log
